  ...
  <div className="text-center">
    ...
    <p className="text-gray-600">Manage all your properties from one convenient dashboard</p>
            ...
            <div className="md:w-2/3 p-8 md:p-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Create an account to add your property</h2>
        ...
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-center text-gray-900 mb-10">What our users say</h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              <div className="flex mb-4">
                <div className="text-[#3ab7b1] flex">
                  {[...Array(5)].map((_, i) => (
              ...
              <p className="text-gray-600 italic mb-4">&quot;I listed my apartment and had it rented within just 3 days. The process was incredibly smooth, and I received multiple qualified offers.&quot;</p>
              <div className="flex items-center">
                <div className="h-10 w-10 rounded-full bg-gray-300"></div>
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-900">Sarah Johnson</p>
                  <p className="text-sm text-gray-500">Property Owner, New York</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 italic mb-4">&quot;The analytics dashboard helped me understand what buyers were looking for, allowing me to adjust my listing and sell my property at the asking price.&quot;</p>
              <div className="flex items-center">
                <div className="h-10 w-10 rounded-full bg-gray-300"></div>
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-900">Michael Chen</p>
                  <p className="text-sm text-gray-500">Property Investor, San Francisco</p>
                </div>
              </div>
            </div>
          </div>
