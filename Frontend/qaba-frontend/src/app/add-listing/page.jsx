...
const AddListingPage = () => {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="md:flex">
            ...
            <div className="md:w-2/3 p-8 md:p-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Get started with property listing in minutes</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="text-lg font-medium text-gray-900">Easy property listing</h3>
                    <p className="mt-1 text-gray-600">Upload multiple high-quality photos and detailed descriptions</p>
                  </div>
                </div>
      ...
      <div className="px-4 sm:px-6 lg:px-14 mt-16">
