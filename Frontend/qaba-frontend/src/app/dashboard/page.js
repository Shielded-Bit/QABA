...
"use client";
import Header1 from '../dashboard/components/header1';
import Header2 from '../dashboard/components/header2';
import PropertiesNumber from '../dashboard/components/propertiesnumber';
