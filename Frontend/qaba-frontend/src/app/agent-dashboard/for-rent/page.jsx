  ...
  return (
    <>
      ...
      <div className="dashboard-numbers sm:pl-10 pl-16 px-6">
        ...
        <h1 className="text-xl font-normal px-2 sm:px-0 py-4 bg-clip-text text-transparent bg-gradient-to-r from-[#014d98] via-[#1d86a9] to-[#3ab7b1]">
          Add Property &gt; <span className="text-[#1d86a9]">For Renting</span>
        </h1>
        <p className="pb-6 px-2 sm:px-0 text-sm text-gray-500">
